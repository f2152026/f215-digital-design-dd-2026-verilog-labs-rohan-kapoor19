...
module tb;
  ...
  initial begin
    ...
    t_i0 = 0; t_i1 = 0; t_s = 0; //000
    #5;
    
    t_i0 = 0; t_i1 = 0; t_s = 1; //001
    #5;
    
    t_i0 = 0; t_i1 = 1; t_s = 0; //010
    #5;
    
    t_i0 = 0; t_i1 = 1; t_s = 1; //011
    #5;
    
    t_i0 = 1; t_i1 = 0; t_s = 0; //100
    #5;
    
    t_i0 = 1; t_i1 = 0; t_s = 1; //101
    #5;
    
    t_i0 = 1; t_i1 = 1; t_s = 0; //110
    #5;
    
    t_i0 = 1; t_i1 = 1; t_s = 1; //111
    #5;
